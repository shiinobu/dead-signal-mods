...
The certificate record is generated by the replay quest after the scan and opened through the supported HackHub virtual filesystem. The replay listens for the `Files.Open` event rather than attempting the unsupported `openssl s_client` syntax.
